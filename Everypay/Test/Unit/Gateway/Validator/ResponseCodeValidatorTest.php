 ...
 */
namespace Everypay\Everypay\Test\Unit\Gateway\Validator;

use Magento\Payment\Gateway\Validator\ResultInterface;
use Magento\Payment\Gateway\Validator\ResultInterfaceFactory;
use Everypay\Everypay\Gateway\Http\Client\ClientMock;
use Everypay\Everypay\Gateway\Validator\ResponseCodeValidator;
...
class ResponseCodeValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        $this->resultFactory = $this->getMockBuilder(
            'Everypay\Payment\Gateway\Validator\ResultInterfaceFactory'
        )
            ->setMethods(['create'])
